...
type AAOSClient interface {
	...
	GetTimetable(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Timetable, error)
	GetCourses(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Courses, error)
	GetExams(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Exams, error)
	GetTranscript(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Transcript, error)
}
...
func (c *aAOSClient) GetInfo(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Info, error) {
	out := new(Info)
...
func (c *aAOSClient) GetTimetable(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Timetable, error) {
	out := new(Timetable)
...
func (c *aAOSClient) GetCourses(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Courses, error) {
	out := new(Courses)
...
func (c *aAOSClient) GetExams(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Exams, error) {
	out := new(Exams)
...
func (c *aAOSClient) GetTranscript(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Transcript, error) {
	out := new(Transcript)
...
func (UnimplementedAAOSServer) GetInfo(context.Context, *empty.Empty) (*Info, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetInfo not implemented")
}
func (UnimplementedAAOSServer) GetTimetable(context.Context, *empty.Empty) (*Timetable, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTimetable not implemented")
}
func (UnimplementedAAOSServer) GetCourses(context.Context, *empty.Empty) (*Courses, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCourses not implemented")
}
func (UnimplementedAAOSServer) GetExams(context.Context, *empty.Empty) (*Exams, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetExams not implemented")
}
func (UnimplementedAAOSServer) GetTranscript(context.Context, *empty.Empty) (*Transcript, error) {
...
func _AAOS_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AAOSServer).GetInfo(ctx, req.(*empty.Empty))
	}
...
func _AAOS_GetTimetable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AAOSServer).GetTimetable(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AAOS_GetCourses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AAOSServer).GetCourses(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AAOS_GetExams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AAOSServer).GetExams(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AAOS_GetTranscript_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AAOSServer).GetTranscript(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AAOS_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/aaos/v4/aaos.proto",
}
