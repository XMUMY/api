...
func (c *authClient) AuthUser(ctx context.Context, in *AuthUserReq, opts ...grpc.CallOption) (*AuthUserResp, error) {
	out := new(AuthUserResp)
	err := c.cc.Invoke(ctx, "/xmux.core.auth.v4.Auth/AuthUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServer) AuthUser(context.Context, *AuthUserReq) (*AuthUserResp, error) {
...
func _Auth_AuthUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xmux.core.auth.v4.Auth/AuthUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).AuthUser(ctx, req.(*AuthUserReq))
	}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "xmux.core.auth.v4.Auth",
